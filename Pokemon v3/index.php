...
<body>
    ...
    <section>
        <h3>Iniciar un combate nuevo</h3>
        <a class="button" href="combate.php">Iniciar Combate</a>
    </section>
...
if (isset($_POST["mostrarEntrenadora"], $_POST["entrenadora"])) {
    ...
    if (isset($_SESSION["entrenadoras"][$idEntrenadora])) {
        $entrenadoraSeleccionada = $_SESSION["entrenadoras"][$idEntrenadora];
        
        $mensaje = $entrenadoraSeleccionada->MostrarEquipo();
    }
}
if (isset($_POST["cazar"], $_POST["entrenadora"], $_POST["pokemon"])) {
    ...
    ?>
    <a class="button" href="crearpokemon.php">Crear Pokémon</a>
